  ...
  return (
    <RadioPrimitive.Root
      ...
      className={cn(
        ...
        "peer relative inline-flex size-4 shrink-0 cursor-pointer items-center justify-center rounded-full border border-gray-700 bg-background-100 outline-none transition-control after:absolute after:-inset-2",
